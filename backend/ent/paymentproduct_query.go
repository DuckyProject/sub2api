...
func (_q *PaymentProductQuery) QueryGroup() *GroupQuery {
...
func (_q *PaymentProductQuery) QueryOrders() *PaymentOrderQuery {
...
func (_q *PaymentProductQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PaymentProductQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *PaymentProductQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PaymentProductQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *PaymentProductQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *PaymentProductQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PaymentProductQuery) WithGroup(opts ...func(*GroupQuery)) *PaymentProductQuery {
	query := (&GroupClient{config: _q.config}).Query()
...
func (_q *PaymentProductQuery) WithOrders(opts ...func(*PaymentOrderQuery)) *PaymentProductQuery {
	query := (&PaymentOrderClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(paymentproduct.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.PaymentProduct.Query().
//		Select(paymentproduct.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *PaymentProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PaymentProduct, error) {
	...
	if query := _q.withGroup; query != nil {
		if err := _q.loadGroup(ctx, query, nodes, nil,
			func(n *PaymentProduct, e *Group) { n.Edges.Group = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOrders; query != nil {
		if err := _q.loadOrders(ctx, query, nodes,
			func(n *PaymentProduct) { n.Edges.Orders = []*PaymentOrder{} },
			func(n *PaymentProduct, e *PaymentOrder) { n.Edges.Orders = append(n.Edges.Orders, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PaymentProductQuery) loadGroup(ctx context.Context, query *GroupQuery, nodes []*PaymentProduct, init func(*PaymentProduct), assign func(*PaymentProduct, *Group)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*PaymentProduct)
	for i := range nodes {
...
func (_q *PaymentProductQuery) loadOrders(ctx context.Context, query *PaymentOrderQuery, nodes []*PaymentProduct, init func(*PaymentProduct), assign func(*PaymentProduct, *PaymentOrder)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(paymentorder.FieldProductID)
	}
	query.Where(predicate.PaymentOrder(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(paymentproduct.OrdersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PaymentProductQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(paymentproduct.Table, paymentproduct.Columns, sqlgraph.NewFieldSpec(paymentproduct.FieldID, field.TypeInt64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withGroup != nil {
			_spec.Node.AddColumnOnce(paymentproduct.FieldGroupID)
		}
	}
...
func (_q *PaymentProductQuery) ForUpdate(opts ...sql.LockOption) *PaymentProductQuery {
...
func (_q *PaymentProductQuery) ForShare(opts ...sql.LockOption) *PaymentProductQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
